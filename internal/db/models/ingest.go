...
type Ingest struct {
	...
	MigrationState  *string    `bson:"migrationState,omitempty" json:"migrationState,omitempty"`
	SourceMediaID   *string    `bson:"sourceMediaId,omitempty" json:"sourceMediaId,omitempty"`
